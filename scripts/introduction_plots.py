...
ppfunctions.plot_initialization_time_vs_qpu_size(ax1, title='(b) Initialization Time vs QPU size')

ppfunctions.plot_execution_time_vs_circuit_size_zac_pachinqo_atomique(ax2, title='(c) Execution time vs Circuit size')
...
fig.savefig('results/introduction_plots.pdf', format='pdf')
